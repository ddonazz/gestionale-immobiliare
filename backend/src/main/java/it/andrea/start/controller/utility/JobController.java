...
public class JobController {
    ...
    @Operation(
            method = "GET",
            description = "List job defined",
            summary = "List job defined",
            responses = {
    ...
    public ResponseEntity<Collection<JobInfoDTO>> listJobs(
            @RequestHeader(name = "accept-language", defaultValue = "it", required = false) String language) throws Exception {
    ...
    @Operation(
            method = "PUT",
            description = "Update un job in esecuzione",
            summary = "Update un job in esecuzione",
            responses = {
                    @ApiResponse(responseCode = "200", description = "OK"),
                    @ApiResponse(responseCode = "400", description = "Bad request", content = @Content(schema = @Schema(hidden = true))),
                    @ApiResponse(responseCode = "401", description = "Not authorized", content = @Content(schema = @Schema(hidden = true))),
